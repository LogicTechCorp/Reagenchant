...
public class UnbreakablePickaxeItem extends UnbreakableToolItem
{
    ...
    public UnbreakablePickaxeItem(IItemTier tier, int attackDamage, float attackSpeed, Properties properties)
    {
        super(attackDamage, attackSpeed, tier, EFFECTIVE_ON, properties.addToolType(ToolType.PICKAXE, tier.getHarvestLevel()));
    }
